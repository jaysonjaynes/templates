  ...
  <div id="page" role="document">
    ...
    <div id="main" role="main" class="clearfix">
      ...
      <?php if ($page['sidebar_first']): ?>
        <aside id="sidebar-first" role="complementary" class="column sidebar side-navigation">
          <?php print render($page['sidebar_first']); ?>
        </aside><!-- #sidebar-first -->
      <?php endif; ?>

      <?php if ($page['sidebar_second']): ?>
        <aside id="sidebar-second" role="complementary" class="column sidebar related-resources">
